...
print(cleancovid$Dem_dependentsgrouped)
...
#dependents and isolation 
 dependents_isolation_interaction <- linear_reg() %>%
  set_engine("lm") %>%
  fit(covidforanalysis$PSSmeans~Dem_gender + Dem_age + Dem_maritalstatus + Dem_isolation + Dem_employment + Dem_dependentsgrouped + Dem_dependents*Dem_isolation, data = cleancovid)
