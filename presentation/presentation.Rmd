...
author: "Statistical Power Puffs: Michelle Huang, Bhavika Garg, Mihika Rajvanshi"
...
```{r visual-gender, warning = FALSE, echo = FALSE, fig.height = 1.5}
cleancovid %>%
...
```{r visual-age, warning = FALSE, echo = FALSE, fig.height = 1.5}
cleancovid %>%
...
```{r visual-isolation, warning = FALSE, echo = FALSE, fig.height = 1.5}
cleancovid %>%
