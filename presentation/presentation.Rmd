...
```{r load-data, include=FALSE, echo = FALSE, cache = TRUE}
...
```{r join-data2, message = FALSE, warning = FALSE, echo = FALSE, cache = TRUE}
...
- The different measures of depression 
...
## Demographics Overview - Isolation Levels
...
## Depression Scales: PSS-10, SLON-3, SPS-15 

## T-Test for Gender (Relationships and Table)

## ANOVA Tests (Relationships and Table)

## Logistic Regression: Age and PSS 

## Logistic Regression: Age and SLON

## Logistic Regression: Age and SPS 

## Linear Regression Table + Equations 

## Linear Regression Overall: PSS

## Linear Regression Overall: SLON

## Linear Regression Overall: SPS
